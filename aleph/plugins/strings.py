...
class StringsPlugin(PluginBase):
    ...
    pattern_uri = re.compile(uri_regex, re.IGNORECASE)
    ...
    def process(self, sample):
        ...
        with open(sample.path) as f:
            ...
            uri_strings = [entry.strip() for entry in self.pattern_uri.findall(file_content)]
